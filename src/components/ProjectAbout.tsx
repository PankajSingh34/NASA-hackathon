    ...
    <div className="min-h-[calc(100vh-5rem)] pb-32 relative">
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-12">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-cyan-300 flex items-center gap-2">🌍 What’s the Topic About?</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: '🌱', text: 'Plant growth, nutrient uptake & photobiology in microgravity.' },
              { icon: '🧑‍🚀', text: 'Bone, muscle, immune, cardiovascular & cognitive system changes.' },
              { icon: '🐭', text: 'Model organism adaptation & developmental biology off Earth.' },
              { icon: '🦠', text: 'Microbial mutation, virulence, biofilms & survival in space.' }
            ].map(item => (
        ...
        {/* Challenge Section */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-amber-300 flex items-center gap-2">🚀 What’s the Challenge Asking?</h2>
        ...
        {/* Importance Section */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-emerald-300 flex items-center gap-2">🌟 Why is This Important?</h2>
          <p className="text-gray-300 max-w-4xl text-base">
        ...
        {/* Platform Value */}
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-pink-300 flex items-center gap-2">🧠 Platform Advantages</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-sky-300">🛠 Architecture Snapshot</h2>
